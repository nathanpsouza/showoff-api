...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "showoff_api_production"
  ...
  # config.active_record.database_resolver = resolver
  # drc = ActiveRecord::Middleware::DatabaseSelector::Resolver::Session
  # config.active_record.database_resolver_context = drc
end
